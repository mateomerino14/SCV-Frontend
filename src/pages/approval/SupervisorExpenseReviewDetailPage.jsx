...
import useSupervisorExpenseReviewDetail from '../../hooks/approval/useSupervisorExpenseReviewDetail';
...
function SupervisorExpenseReviewDetailPage() {
  const {id} = useParams();
  ...
  } = useSupervisorExpenseReviewDetail(id);
...
export default SupervisorExpenseReviewDetailPage;