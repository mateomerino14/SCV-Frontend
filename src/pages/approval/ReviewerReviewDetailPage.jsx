...
const styles = {
  ...
  warningMsg: 'text-xs font-inter text-center mt-2',
    ...
    return (
      <div className={styles.page} style={{backgroundColor: COLORS.background}}>
        ...
        <div className={styles.content}>
          <div className="rounded-2xl p-8 text-center" style={{backgroundColor: successBg}}>
            <p className="text-lg font-bold font-inter" style={{color: successColor}}>{successMessage}</p>
            {warning && <p className={styles.warningMsg} style={{color: '#856404'}}>{warning}</p>}
            <button className="mt-4 py-2.5 px-6 rounded-xl font-bold font-nunito text-sm" style={{backgroundColor: COLORS.primary, color: COLORS.background}}
