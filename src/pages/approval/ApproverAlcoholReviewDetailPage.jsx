...
import useApproverAlcoholReviewDetail from '../../hooks/approval/useApproverAlcoholReviewDetail';
...
function ApproverAlcoholReviewDetailPage() {
  const {id} = useParams();
  const navigate = useNavigate();
  const location = useLocation();
  const originRoute = location.state?.from || routes.approverAlcoholReviews;
  ...
  const {
    ...
    handleApprove, handleRequestReject, handleReject, handleReturn,
    handleAddComment, handleOpenEdit, handleConfirmEdit, handleOpenDelete, handleConfirmDelete,
  } = useApproverAlcoholReviewDetail(id);
  ...
  const isMine = trip.id_aprobador_asignado === currentUserId;
...
export default ApproverAlcoholReviewDetailPage;