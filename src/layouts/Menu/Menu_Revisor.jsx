...
import { ClipboardList, Briefcase, Plane, User, Settings, LogOut, X, Wallet, AlertTriangle } from 'lucide-react'
...
const seccionRevisionFinal = [
  { path: '/dashboard/revisor', label: 'Revisión Final', icono: ClipboardList },
  { path: '/dashboard/revisor/solicitudes-plazo', label: 'Solicitudes de Plazo', icono: AlertTriangle },
]
...
function MenuRevisor({ isOpen, onClose, usuario }) {
  ...
  const esActivo = (path) => {
    if (['/dashboard/revisor', '/dashboard/empleado'].includes(path)) {
        ...
        <div className={styles.navScroll}>
          <div className={styles.nav}>
            <div className={styles.grupo} style={{ borderColor: COLORS.dataFields }}>
              <p className={styles.seccionLabel} style={{ color: COLORS.labels }}>Revisión Final</p>
              {renderOpciones(seccionRevisionFinal)}
            </div>
