...
import { ClipboardList, History, Plane, User, Settings, LogOut, X, Briefcase } from 'lucide-react'
...
const opciones = [
  { path: '/dashboard/supervisor', label: 'Revisiones', icono: ClipboardList },
  { path: '/dashboard/supervisor/historial', label: 'Historial', icono: History },
