...
function ExpenseItem({expense, tripInProgress, onDelete, tripId, originTrip, observations = []}) {
  ...
  return (
    <div style={{backgroundColor: COLORS.background, border: `1px solid ${COLORS.dataFields}`, borderLeft: `3px solid ${accentColor}`, borderRadius: 12, marginBottom: 8, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 6}}>
