...
import EmployeeHeader from '../molecules/EmployeeHeader';
...
const styles = {
  ...
  reason: "text-sm font-bold font-inter leading-tight mb-1",
  dateRow: "flex items-center gap-1 mb-1",
...
function PendingTripItem({trip, detailRoute, originRoute, onTake, onReturn, taking, assignedField = 'id_supervisor_asignado', detailLabel = 'Ver Detalle'}) {
  ...
  return (
    <div className={styles.container} style={{borderColor: COLORS.dataFields, backgroundColor: COLORS.background}}>
      <div className="flex items-start justify-between gap-3">
        {trip.Usuario ? (
          <div className="flex items-center gap-2.5 min-w-0">
            <img src={trip.Usuario.foto_perfil} alt="empleado" className="w-11 h-11 rounded-full object-cover border shrink-0" style={{borderColor: COLORS.dataFields}} />
