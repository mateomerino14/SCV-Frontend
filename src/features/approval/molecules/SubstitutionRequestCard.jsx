...
function SubstitutionRequestCard({request, onApprove, onReject, savingAction, showActions}) {
  ...
  return (
    <div className={styles.card} style={{backgroundColor: COLORS.background, border: `1px solid ${COLORS.dataFields}`}}>
      ...
      <div className={styles.reasonBox} style={{backgroundColor: COLORS.backgroundHeader}}>
        <p className={styles.reasonLabel} style={{color: COLORS.labels}}>Sustituto propuesto</p>
        <p className={styles.reasonText} style={{color: COLORS.text}}>{request.Sustituto?.nombre} {request.Sustituto?.apellido_paterno}</p>
