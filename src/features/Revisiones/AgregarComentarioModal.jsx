...
function AgregarComentarioModal({ isOpen, onClose, onConfirm, observaciones, onEditar, loading, error }) {
    ...
    <div className={styles.overlay}>
      ...
      <div className={styles.card} style={{ backgroundColor: COLORS.primary }}>
        ...
        <p className={styles.subtitulo} style={{ color: COLORS.backgroundHeader }}>
          Se observó el gasto indebido del presupuesto del empleado.
        </p>
        ...
        <div className={styles.textareaWrapper}>
          <textarea
            ...
            onChange={(e) => onEditar(0, e.target.value)}
          />
          {excedeLongitud && (
...
export default AgregarComentarioModal;