...
function ConfigOption({icon: Icon, label, onClick}) {
  return (
    <div className={styles.wrapper} style={{backgroundColor: COLORS.background, border: `1px solid ${COLORS.fields}`}} onClick={onClick}>
