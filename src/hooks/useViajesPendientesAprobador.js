...
import { getViajesPendientesAprobador } from '../services/aprobadorService'

const POLLING_INTERVAL = 30 * 1000

function useViajesPendientesAprobador() {
  ...
  const cargar = async (f = filtrosRef.current) => {
    const data = await getViajesPendientesAprobador(f)
...
export default useViajesPendientesAprobador;